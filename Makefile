...
help:
	@echo "Alvos disponiveis (frontend Node; o backend Go tem o proprio Makefile em apps/backend/):"
	...
	@echo "  make test      - lembra onde rodar os testes (Go: make -C apps/backend test)"
...
test:
	@echo "Backend Go: 'make -C apps/backend test'. Frontend: ver .claude/specs/014, 017."
