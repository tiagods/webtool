...
export const metadata: Metadata = {
  title: 'Prolink | Abertura de Empresa',
  description: 'Prossiga com a sua ficha de abertura digital pela Prolink Contábil.',
};

export default function AberturaLayout({ children }: { children: React.ReactNode }) {
  return (
        ...
        <div className="w-full max-w-[1020px] mx-auto flex items-center px-4 md:px-0">
          ...
          <div className="ml-auto hidden sm:flex items-center gap-2">
            ...
            <span className="text-white/60 text-[13px] font-medium tracking-wide">
              Abertura de Empresa — Formulário Digital
            </span>
          </div>
        </div>
      </header>
