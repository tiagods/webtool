...
//go:generate go tool mockgen -typed -package mocks -destination token_service.go github.com/tiagods/webtool/apps/backend/domain/ports/outbound TokenService
